...
const whitePartEye =
  "M255 374C315.751 374 365 324.527 365 263.5C365 202.473 315.751 153 255 153C194.249 153 145 202.473 145 263.5C145 324.527 194.249 374 255 374Z";
const jellyFishBody =
  "M255.5 401C331.439 401 393 339.439 393 263.5C393 187.561 331.439 126 255.5 126C179.561 126 118 187.561 118 263.5C118 339.439 179.561 401 255.5 401Z";
const emphases = [
  {
