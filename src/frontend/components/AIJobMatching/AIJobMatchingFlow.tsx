...
const AIJobMatchingFlow = () => {
  ...
  return (
    <Box sx={{ py: { xs: 8, md: 12 }, bgcolor: theme.palette.mode === "dark" ? "#0a0a0a" : "grey.50" }}>
      <Container maxWidth="lg">
        ...
        <Box sx={{ 
          ...
          <Grid2 container>
            <Grid2 xs={12} md={6} sx={{ 
              borderRight: { md: `1px solid ${theme.palette.mode === "dark" ? "#2a2a2a" : theme.palette.divider}` },
              borderBottom: { xs: `1px solid ${theme.palette.mode === "dark" ? "#2a2a2a" : theme.palette.divider}`, md: "none" }
            }}>
              <Box sx={{ p: { xs: 3, md: 4 }, minHeight: { xs: "280px", md: "400px" } }}>
                <Box sx={{ mb: 3 }}>
                ...
                <Box sx={{ 
                  position: "relative",
                  bgcolor: theme.palette.mode === "dark" ? "#252525" : "grey.100",
                  borderRadius: "16px",
                  p: 2.5,
                  minHeight: "56px",
                  display: "flex",
                  ...
                  <Typography 
                    variant="body1" 
                    sx={{ 
                      color: theme.palette.mode === "dark" ? "#e0e0e0" : "grey.900",
                ...
                <Box sx={{ mt: 3, display: "flex", gap: 1.5, flexWrap: "wrap" }}>
                  {["Frontend Dev", "Marketing", "Design", "Backend"].map((tag) => (
                    <Chip 
                      key={tag}
                      label={tag} 
                      size="small" 
            ...
            <Grid2 xs={12} md={6}>
              <Box sx={{ p: { xs: 3, md: 4 }, minHeight: { xs: "280px", md: "400px" } }}>
                <Box sx={{ mb: 3, display: "flex", alignItems: "center", gap: 1.5 }}>
                  <Typography variant="overline" sx={{ 
                    color: visibleCandidates > 0 ? "#4caf50" : "text.secondary",
                    fontWeight: 700,
                    letterSpacing: 1.2,
                    fontSize: "0.7rem"
                  }}>
                ...
                {visibleCandidates > 0 ? (
                  <Stack spacing={1.5}>
                    {candidates.slice(0, visibleCandidates).map((candidate, index) => (
