      ...
      For availability actions, use this format:
      {
        ...
        "data": {
          ...
          "availability": {
            ...
            "schedule_type": {
                "WeeklyRecurring": {
                  "days": [],  "days": [],  // this can be [1, 2, 3, 4] where Monday    = 1 Tuesday   = 2 Wednesday = 3 Thursday  = 4 Friday    = 5 Saturday  = 6 Sunday    = 7, "Note: if a day repeated in older avialibies make update the old one to remove it.
                  "valid_until": []  // keep it empty list
                }
              },
            "slots": [
              {
