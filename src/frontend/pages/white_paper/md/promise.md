...
| **Released**               | Payment completed      | Money transferred, debt cleared                   | _Final state_                           |
| **Request Cancellation**   | Sender wants to cancel | No change until receiver responds                 | Wait for cancellation confirmation      |
| **Confirmed Cancellation** | Mutually cancelled     | Spending limit restored, no money moved           | _Final state_                           |
