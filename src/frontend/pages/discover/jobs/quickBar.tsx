...
const JobUpdateAnimation = ({ currentJob, jobs }) => {
  ...
  useEffect(() => {
    ...
    const changes = [];
    const fieldsToCheck = [
      'skills', 'education', 'links', 'experience', 'certifications', 
      'job_titles', 'emails', 'contacts', 'description', 'proficiency_level',
      'trust_score', 'trust_note', 'required_match_score'
    ];
  ...
  return (
    ...
    >
      ...
      <div style={{ minHeight: '120px', overflow: 'hidden', position: 'relative' }}>
          ...
          >
            {currentUpdate?.type === 'array' ? (
                ...
                <AnimatePresence>
                  ...
                  {currentUpdate.current.map((item, index) => {
                    ...
                    return (
                      ...
                      >
                        {isNew && <span style={{ color: '#10b981', marginRight: '6px' }}>+</span>}
                        {item}
                      </motion.div>
                    );
                  })}
                  ...
                  {currentUpdate.removed.map((item, index) => (
                    <motion.div
                      key={`removing-${item}`}
                      layout
                      initial={{ opacity: 1, x: 0, scale: 1, background: '#2a2a2a' }}
                      animate={[
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                ...
                >
                  <span style={{ color: '#ef4444', marginRight: '6px', fontSize: '10px' }}>-</span>
                ...
                >
                  <span style={{ color: '#10b981', marginRight: '6px', fontSize: '10px' }}>+</span>
