  ...
  useEffect(() => {
    const sequence = [
      ...
      },
      {
        id: 3,
        type: "user",
        text: "Find a suitable time to meet Sarah",
        delay: 2000,
      },
      {
        id: 4,
      ...
      <Container maxWidth="lg">
        <Box sx={{ display: "flex", alignItems: "center", gap: 6 }}>
          <Box sx={{ flex: "1 1 50%" }}>
            ...
            >
              The first and only AI personal secretary on Web3. Find jobs and
              talent, schedule meetings, manage teams & payments.
            </Typography>
...
const FunnelOverviewSection = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description:
        "Secure platform handles projects, teams, tasks, payments, and contract management",
      icon: "/contract.png",
    },
  ];
  ...
  const imgStyles = {
    ...
    objectFit: "contain",
    filter: isDark
      ? "brightness(0.85) drop-shadow(0 2px 8px rgba(0, 0, 0, 0.6))"
                  ...
                  <img
                    ...
                    onMouseEnter={(e) =>
                      (e.currentTarget.style.filter = isDark
                        ? "brightness(1.15) drop-shadow(0 4px 12px rgba(255, 255, 255, 0.3))"
                        : "brightness(1.05) drop-shadow(0 6px 16px rgba(0, 0, 0, 0.5))")
                    }
                    onMouseLeave={(e) =>
                      (e.currentTarget.style.filter = imgStyles.filter)
                    }
                  />
                </Box>
                <Typography
      ...
      <Container maxWidth="lg">
        <Grid2 container spacing={6} alignItems="center">
          <Grid2 xs={6}>
            <Typography
              variant="h3"
              sx={{ mb: 2, fontWeight: 600, fontSize: "2.5rem" }}
            >
              Email Alerts
            </Typography>
            <Typography
            ...
            >
              Get notified when new opportunities match your profile. Never miss
              the perfect job or talent again.
            </Typography>
          </Grid2>
          <Grid2 xs={6}>
            <Box
              ...
              {emails.map((email, i) => (
                ...
                >
                  ...
                  >
                    <Typography
                      variant="body1"
                      sx={{ fontWeight: 500, lineHeight: 1.4, pr: 2 }}
                    >
                      {email.subject}
                    </Typography>
                    <Typography
  ...
  const proofs = [
    {
      ...
      icon: <AttachMoney sx={{ fontSize: "2rem", color: "primary.main" }} />,
    },
    {
      title: "Proof of Stake",
      subtitle: "Build trust with upfront staking",
      icon: <Lock sx={{ fontSize: "2rem", color: "primary.main" }} />,
    },
    {
      title: "Proof of Cap",
      subtitle: "Smart limits prevent oversized commitments",
      icon: <BarChart sx={{ fontSize: "2rem", color: "primary.main" }} />,
    },
    {
          ...
          {proofs.map((proof, i) => (
            ...
            >
              ...
              <Box>
                <Typography
                  variant="h6"
                  sx={{ mb: 0.75, fontWeight: 600, fontSize: "1.25rem" }}
                >
                  {proof.title}
                </Typography>
                <Typography
    ...
    >
      <Box sx={{ mb: 2 }}>
        ...
        <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
          <Avatar sx={{ width: 32, height: 32 }} src={contract.avatar}>
            {contract.creator
              .split(" ")
              .map((n) => n[0])
              .join("")}
...
const ProjectManagementStep = () => {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      setPromiseData({
        count: contracts[nextIdx].promises,
        amount: contracts[nextIdx].amount,
      });
  ...
  const features = [
    {
      icon: <SmartToy sx={{ fontSize: "1.5rem", color: "primary.main" }} />,
      text: "Smart task allocation",
    },
    {
      icon: <AttachMoney sx={{ fontSize: "1.5rem", color: "primary.main" }} />,
      text: "Automated payment tracking",
    },
    {
      icon: <BarChart sx={{ fontSize: "1.5rem", color: "primary.main" }} />,
      text: "Progress analytics",
    },
    {
      icon: (
        <Notifications sx={{ fontSize: "1.5rem", color: "primary.main" }} />
      ),
      ...
      <Container maxWidth="lg">
        <Grid2 container spacing={6} alignItems="center">
          <Grid2 xs={12} md={6}>
            ...
            <Typography
              variant="body1"
              sx={{ opacity: 0.8, mb: 4, fontSize: "1.1rem", lineHeight: 1.6 }}
            >
              Manage team tasks, payments, and contracts A-Z with the help of AI
            </Typography>
            <Typography
              variant="h6"
              sx={{ mb: 3, opacity: 0.9, fontSize: "1.2rem", fontWeight: 500 }}
            >
  ...
  return (
    ...
    >
      <Container maxWidth={isMobile ? "sm" : "lg"}>
        <Typography
          variant="h6"
          sx={{ mb: 3, fontWeight: isMobile ? 600 : 500 }}
        >
          Join Our Community
        </Typography>
        <Box
