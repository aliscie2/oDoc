          ...
          <CardContent sx={{ p: chatExpanded ? 2 : 1, height: '100%' }}>
            {!chatExpanded ? (
              ...
              <Box sx={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
                ...
                <Box sx={{ flex: 1, mb: 2, minHeight: 120, overflow: 'hidden' }}>
                  ...
                  <Box display="flex" alignItems="center" gap={2} flexWrap="wrap">
                    ...
                    <Box position="relative" sx={{ flexShrink: 0 }}>
                      <CircularProgress
                        ...
                        size={60}
                        thickness={6}
                        sx={{ color: match.score >= 90 ? 'success.main' : 'warning.main' }}
                      />
                      <Box sx={{
                        position: 'absolute',
                        inset: 0,
                    ...
                    <Box sx={{ 
                      ...
                      <Button
                        ...
                        variant="contained"
                        size="small"
                        startIcon={connectClicked && index === 0 ? <CheckCircle /> : <PersonAdd />}
                        sx={{
                          bgcolor: connectClicked && index === 0 ? 'success.main' : 'primary.main',
                          fontSize: '0.85rem',
                          minWidth: { xs: 100, sm: 110 },
                          height: 40,
                          '&:hover': {
                            bgcolor: connectClicked && index === 0 ? 'success.dark' : 'primary.dark'
                          }
                        }}
                      >
                        {connectClicked && index === 0 ? 'Connected!' : 'Connect'}
                      </Button>
                    </Box>
                  </Box>
                </Card>
      ...
      <Fade in={showFinalPopup} timeout={1000}>
        ...
        >
          ...
          <Typography variant="h6" sx={{ 
            ...
            Don't see perfect matches yet? No worries! Just wait an our system will Alert you via email 🔔.
          </Typography>
        </Box>
      </Fade>
