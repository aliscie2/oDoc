...
const FeatureSection = ({ title, icon, children, reversed = false }) => {
 ...
 return (
   <Box sx={{ py: 6, minHeight: "100vh", display: "flex", alignItems: "center" }}>
     <Grid
       container
       spacing={6}
     ...
     >
       <Grid item xs={12} md={6}>
         <Box sx={{ display: "flex", flexDirection: "column", alignItems: isMobile ? "center" : "flex-start" }}>
           {isMobile && <Box 
           style={{
            filter: "drop-shadow(rgba(167, 116, 116, 0.15) 10px 10px 20px)",
           }}
           sx={{ 
            mb: 3,
            }}>{icon}</Box>}
 ...
 return (
   <Box sx={{ minHeight: "100vh" }}>
     <Container maxWidth="lg" sx={{ py: 4 }}>
       ...
       {!isMobile && (
         <Box sx={{ py: 2, minHeight: "100vh", display: "flex", alignItems: "center" }}>
           <OdocStrecture />
         </Box>
       )}

       <Box sx={{ py: 6, minHeight: "100vh", display: "flex", flexDirection: "column", justifyContent: "center" }}>
         <Typography
           variant="h4"
           gutterBottom
           textAlign="center"
       ...
       >
         <Typography
           ...
           sx={{ mb: 3 }}
         >
           No need to manually set your availabilities, you can just talk to it like talking to a human.
         </Typography>
         <List sx={{ "& .MuiListItem-root": { pl: 0 } }}>
           {[
