...
export const securityFeatures = [
  {
    ...
    description: "Immutable blockchain records maintain audit integrity",
  },
  {
    icon: <Architecture />,
    title: "Decentralized Architecture",
    description: "Distributed network eliminates single points of failure",
  },
  {
    icon: <VerifiedUser />,
    title: "Verified Access",
    description: "Biometric authentication and digital identity verification",
  },
  {
    icon: <GppGood />,
    title: "Fraud Prevention",
    description: "Smart contracts with cryptographic transaction validation",
  },
  {
    icon: <Shield />,
    title: "Secure Comms",
    description: "End-to-end encrypted messaging protocols",
  },
  {
    icon: <MonitorHeart />,
...
export const benefitsData: BenefitData[] = [
  {
    ...
    description:
      "Replace 3+ apps with one.\nNo more PayPal, Upwork, Jira — ODoc handles it all.",
    expandedContent:
      "Cut operational costs by 60% and reduce tool switching by 80%. Single subscription replaces multiple SaaS tools, streamlining your entire workflow and boosting productivity.",
    icon: <AccessTime />,
  ...
  },
  {
    ...
    description:
      "Privacy that doesn't change overnight.\nTransparent, secure, and censorship-resistant.",
    expandedContent:
      "Immutable smart contracts ensure your agreements can't be altered. Full transparency with on-chain verification and decentralized architecture for ultimate security.",
    icon: <Security />,
  ...
  },
  {
    ...
    description:
      "Vote on features and updates.\nNo more forced changes — you decide.",
    expandedContent:
      "DAO governance model means community decides platform direction. Your voice matters in every update and feature decision through democratic voting.",
    icon: <Gavel />,
  ...
  },
  {
    ...
    expandedContent:
      "ML-powered analytics provide actionable insights. Predictive models help optimize your workflow efficiency and decision-making process with real-time guidance.",
    icon: <Psychology />,
  ...
  },
  {
    ...
    title: "Open Source",
    description:
      "See the code. Trust the platform.\nYou know exactly where your data goes.",
    expandedContent:
      "Full code transparency on GitHub. Community-driven development with regular security audits and open contribution model for maximum trust.",
    icon: <Code />,
  ...
  },
  {
    ...
    description:
      "Payments, hiring, tasks, and contracts — unified.\nNo switching. Everything in one place.",
    expandedContent:
      "Seamless integration across all business functions. Single dashboard for complete project lifecycle management and team coordination without context switching.",
    icon: <AccountTree />,
...
export const odocStrecutre: Element[] = [
  {
    ...
    description:
      "Match-based system finds opportunities instantly, or get alerted later.",
    icon: (
      <img
        src={jobMatcherImage}
        width="50px"
  ...
  },
  {
    ...
    icon: (
      <img
        src={autoReleaseImage}
        width="60px"
        style={{ filter: "drop-shadow(0 0 8px rgba(255, 149, 0, 0.8))" }}
      />
    ),
    angle: 40.5,
  ...
  },
  {
    ...
    icon: (
      <img
        src={karmaImage}
        width="50px"
        style={{ filter: "drop-shadow(0 0 8px rgba(184, 76, 255, 0.8))" }}
      />
    ),
    angle: 312,
  ...
  },
  {
    ...
    icon: (
      <img
        src={snsimage}
        width="50px"
        style={{ filter: "drop-shadow(0 0 8px rgba(255, 76, 139, 0.8))" }}
      />
    ),
    angle: 0,
  ...
  },
  {
    ...
    icon: (
      <img
        src={identityImage}
        width="50px"
        style={{ filter: "drop-shadow(0 0 8px rgba(76, 154, 255, 0.8))" }}
      />
    ),
    angle: 180,
