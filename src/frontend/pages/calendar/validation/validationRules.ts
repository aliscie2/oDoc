...
import { ValidationScenario, ValidationRuleSet, ValidationContext, ValidationResult } from './validationTypes';
import {
  isPastTimeSlot,
  checkBlockedSlots,
...
export const VALIDATION_RULES: ValidationRuleSet = {
  ...
  [ValidationScenario.SHARED_CALENDAR_BASIC]: [
    ...
    },
    {
      ...
      errorMessage: "This time slot is not available in the calendar owner's schedule",
    },
    {
  ...
  [ValidationScenario.SHARED_CALENDAR_CONTRIBUTOR]: [
    ...
    },
    {
      ...
      errorMessage: 'This time slot conflicts with an existing event on this calendar',
    },
    {
      name: 'check_event_permission',
      description: 'User must have permission to modify event',
  ...
  [ValidationScenario.SHARED_CALENDAR_ADVANCED]: [
    ...
    },
    {
      ...
      errorMessage: 'This time slot conflicts with an event on your own calendar',
    },
    {
      name: 'check_event_permission',
      description: 'User must have permission to modify event',
