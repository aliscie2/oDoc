export const idlFactory = ({ IDL }) => {
  ...
  const AiResponse = IDL.Record({
    'remaining_credits' : IDL.Float64,
    'response' : IDL.Text,
  });
  const Result_4 = IDL.Variant({ 'Ok' : AiResponse, 'Err' : IDL.Text });
  ...
  const Result_5 = IDL.Variant({ 'Ok' : GetTransactions, 'Err' : Error });
  ...
  const Result_6 = IDL.Variant({ 'Ok' : WorkSpace, 'Err' : IDL.Text });
  ...
  const Result_7 = IDL.Variant({ 'Ok' : Wallet, 'Err' : Error });
  ...
  const Result_8 = IDL.Variant({ 'Ok' : Affiliate, 'Err' : IDL.Text });
  const Result_9 = IDL.Variant({ 'Ok' : IDL.Float32, 'Err' : IDL.Text });
  ...
  const RecurrenceRule = IDL.Record({
    'interval' : IDL.Int32,
    'count' : IDL.Opt(IDL.Int32),
    'until' : IDL.Opt(IDL.Float64),
  ...
  const Event = IDL.Record({
    ...
    'start_time' : IDL.Float64,
    'attendees' : IDL.Vec(IDL.Text),
  });
  const ScheduleType = IDL.Variant({
    'DateRange' : IDL.Record({
      'end_date' : IDL.Float64,
      'start_date' : IDL.Float64,
    }),
    'WeeklyRecurring' : IDL.Record({
      'days' : IDL.Vec(IDL.Nat32),
      'valid_until' : IDL.Opt(IDL.Float64),
    }),
    'SpecificDates' : IDL.Vec(IDL.Float64),
  });
  ...
  const Availability = IDL.Record({
    ...
    'time_slots' : IDL.Vec(TimeSlot),
  });
  const Calendar = IDL.Record({
    'id' : IDL.Text,
    'owner' : IDL.Text,
    'google_public_urls' : IDL.Vec(IDL.Text),
  ...
  const Result_11 = IDL.Variant({ 'Ok' : StoredContract, 'Err' : IDL.Text });
  ...
  const Result_12 = IDL.Variant({ 'Ok' : InitialData, 'Err' : IDL.Text });
  ...
  const Result_13 = IDL.Variant({ 'Ok' : Post, 'Err' : IDL.Text });
  const ShareFile = IDL.Record({ 'id' : IDL.Text, 'owner' : IDL.Principal });
  const Result_14 = IDL.Variant({ 'Ok' : ShareFile, 'Err' : IDL.Text });
  const Result_15 = IDL.Variant({
    'Ok' : IDL.Tuple(FileNode, IDL.Vec(ContentNode)),
    'Err' : IDL.Text,
  });
  const SNSStatus = IDL.Record({
    'talents_count' : IDL.Float64,
    'latest_jobs' : IDL.Vec(Job),
    'latest_talents' : IDL.Vec(Job),
    'number_users' : IDL.Float64,
    'active_users' : IDL.Float64,
    'jobs_count' : IDL.Float64,
  });
  const Result_16 = IDL.Variant({ 'Ok' : SNSStatus, 'Err' : IDL.Text });
  ...
  const CalendarActions = IDL.Record({
    'delete_availabilities' : IDL.Vec(IDL.Text),
    'delete_events' : IDL.Vec(IDL.Text),
    'events' : IDL.Vec(Event),
    'availabilities' : IDL.Vec(Availability),
  });
  const Result_20 = IDL.Variant({ 'Ok' : Calendar, 'Err' : IDL.Text });
  ...
  const MatchChanges = IDL.Record({
    'add' : IDL.Vec(Match),
    'current_job_id' : IDL.Text,
    'delete_matches' : IDL.Vec(IDL.Text),
    'updates' : IDL.Vec(Match),
    'reset' : IDL.Opt(IDL.Vec(Match)),
  });
  ...
  return IDL.Service({
    ...
    'add_google_calendar_id' : IDL.Func(
    ...
    'check_external_transactions' : IDL.Func([IDL.Nat], [Result_5], []),
    ...
    'get_share_file' : IDL.Func([IDL.Text], [Result_14], ['query']),
    'get_shared_file' : IDL.Func([IDL.Text], [Result_15], []),
    'get_sns_status' : IDL.Func([], [Result_16], ['query']),
    'get_swaps' : IDL.Func(
        [],
    ...
    'is_ai_free_tier' : IDL.Func([], [Result_18], ['query']),
    ...
    'move_file' : IDL.Func([IDL.Text, IDL.Opt(IDL.Text)], [Result_19], []),
    ...
    'save_work_space' : IDL.Func([WorkSpace], [Result_6], []),
    'search_posts' : IDL.Func([IDL.Text], [IDL.Vec(PostUser)], ['query']),
    'see_notifications' : IDL.Func([IDL.Vec(IDL.Text)], [Result_1], []),
    ...
    'share_file' : IDL.Func([ShareFileInput], [Result_14], []),
    'store_calendar_public_url' : IDL.Func(
        [IDL.Text, IDL.Text],
        [Result_3],
        [],
      ),
    ...
    'unvote' : IDL.Func([IDL.Text], [Result_13], []),
    'update_calendar' : IDL.Func([IDL.Text, CalendarActions], [Result_20], []),
    ...
    'update_matches' : IDL.Func(
        [MatchChanges, IDL.Opt(IDL.Float32)],
        [Result_3],
        [],
      ),
    ...
    'ws_open' : IDL.Func([CanisterWsOpenArguments], [Result_3], []),
  });
};
