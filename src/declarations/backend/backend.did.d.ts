...
export type Result_10 = { Ok: Post } | { Err: string };
export type Result_11 = { Ok: ShareFile } | { Err: string };
export type Result_12 =
  | { Ok: [FileNode, Array<ContentNode>] }
  | { Err: string };
export type Result_13 = { Ok: SNSStatus } | { Err: string };
export type Result_14 = { Ok: UserProfile } | { Err: string };
export type Result_15 = { Ok: null } | { Err: null };
export type Result_16 = { Ok: Calendar } | { Err: string };
...
export type Result_8 = { Ok: StoredContract } | { Err: string };
export type Result_9 = { Ok: InitialData } | { Err: string };
