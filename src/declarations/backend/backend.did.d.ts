...
export interface _SERVICE {
  ...
  'deposit_ckusdc' : ActorMethod<[], Result_7>,
  'deposit_ckusdt' : ActorMethod<[], Result_7>,
  'deposit_stablecoins' : ActorMethod<[], Result_7>,
  ...
  'get_contracts_count' : ActorMethod<[], bigint>,
  'get_contracts_paginated' : ActorMethod<
    [bigint, bigint],
  ...
  'get_filtered_posts' : ActorMethod<
    ...
    Array<PostUser>
  >,
  'get_friends_count' : ActorMethod<[], bigint>,
  'get_friends_paginated' : ActorMethod<[bigint, bigint], Array<FEFriend>>,
  ...
  'get_notifications_count' : ActorMethod<[], bigint>,
  ...
  'get_unread_notifications_count' : ActorMethod<[], bigint>,
  ...
  'get_wallet_debts' : ActorMethod<[bigint, bigint], Array<[string, number]>>,
  'get_wallet_debts_count' : ActorMethod<[], bigint>,
  'get_wallet_exchanges' : ActorMethod<[bigint, bigint], Array<Exchange>>,
  'get_wallet_exchanges_count' : ActorMethod<[], bigint>,
  ...
  'withdraw_ckusdc' : ActorMethod<[bigint, string], Result_7>,
